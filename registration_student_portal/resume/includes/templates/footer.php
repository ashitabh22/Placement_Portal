		...
		<script type="text/javascript">
			function addRow(DOC_ID, ARR_METHOD, ARR_METHOD1, TEXT_ID, COUNT){
				var countval = (COUNT + 1);
				var cntTr = $("#" + DOC_ID + "tr").length;
        		var tdStr = '<tr>';

        		tdStr += '<td><input  type="text" name="' + ARR_METHOD + '[]" id="' + TEXT_ID + countval + '" class="form-control"> </td><td><input type="text" name="' + ARR_METHOD1 + '[]" id="' + TEXT_ID + countval + '" class="form-control"> </td><td><input type="button" class="btn btn-danger" style="cursor: pointer;" value="Delete" onclick="removeRow1(this, \'' + DOC_ID + '\')" style="cursor:pointer;" /></td>';
        		tdStr += '</tr>';
		        $("#" + DOC_ID + "").each(
		                function ()
		           {
