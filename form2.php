    ...
    <div class="container-fluid">
        <div class="panel-group">
            <div class="panel panel-primary">
                <div class="panel-heading" style="background-color: #6153a8;">Fill out the form<span style="color: #FFFFFF; float: right;"><?php echo $_SESSION[SES]['uname']; ?><b style="color: #000000;"> (<?php echo $_SESSION[SES]['email']; ?>)</b></span></div>
                                    ...
                                    <table class="table table-bordered table-responsive" id="table2">
                                        ...
                                        if ($techskill_data['NO_OF_ITEMS'] > 0) {
                                            for ($i = 0; $i < $techskill_data['NO_OF_ITEMS']; $i++) {
                                                ...
                                                <?php } ?>
                                                <td>
                                                    <input type="button" class="btn btn-primary" style="cursor: pointer;" value="Add row" onclick="addRow2('table2', 'sk_skill', 'sk_slno', 'skill', '0')">
                                                </td>
                                            </tr>
                                        <?php } else { ?>
                                            <tr>
                                    ...
                                    <table class="table table-bordered table-responsive" id="table3">
                                        ...
                                        if ($intern_data['NO_OF_ITEMS'] > 0) {
                                            for ($i = 0; $i < $intern_data['NO_OF_ITEMS']; $i++) {
                                                ...
                                                <?php } ?>
                                                <td>
                                                    <input type="button" class="btn btn-primary" style="cursor: pointer;" value="Add row" onclick="addRow('table3', 'in_slno', 'in_name', 'in_duration', 'intern', '0')">
                                                </td>
                                            </tr>
                                        <?php } else { ?>
                                            <tr>
                                    ...
                                    <table class="table table-bordered table-responsive" id="table4">
                                        ...
                                        if ($responsbility_data['NO_OF_ITEMS'] > 0) {
                                            for ($i = 0; $i < $responsbility_data['NO_OF_ITEMS']; $i++) {
                                                ...
                                                <?php } ?>
                                                <td>
                                                    <input type="button" class="btn btn-primary" style="cursor: pointer;" value="Add row" onclick="addRow('table4', 'por_slno', 'por_name', 'por_duration', 'por', '0')">
                                                </td>
                                            </tr>
                                        <?php } else { ?>
                                            <tr>
                                    ...
                                    <table class="table table-bordered table-responsive" id="table5">
                                        ...
                                        if ($work_experience['NO_OF_ITEMS'] > 0) {
                                            for ($i = 0; $i < $work_experience['NO_OF_ITEMS']; $i++) {
                                                ...
                                                <?php } ?>
                                                <td>
                                                    <input type="button" class="btn btn-primary" style="cursor: pointer;" value="Add row" onclick="addRow('table5', 'we_slno', 'we_name', 'we_duration', 'we', '0')">
                                                </td>
                                            </tr>
                                        <?php } else { ?>
                                            <tr>
                                    ...
                                    <table class="table table-bordered table-responsive" id="table6">
                                        ...
                                        if ($projects['NO_OF_ITEMS'] > 0) {
                                            for ($i = 0; $i < $projects['NO_OF_ITEMS']; $i++) {
                                                ...
                                                <?php } ?>
                                                <td>
                                                    <input type="button" class="btn btn-primary" style="cursor: pointer;" value="Add row" onclick="addRow('table6', 'pr_slno', 'pr_name', 'pr_duration', 'pr', '0')">
                                                </td>
                                            </tr>
                                        <?php } else { ?>
                                            <tr>
                                    ...
                                    <table class="table table-bordered table-responsive" id="table7">
                                        ...
                                        if ($extra_curr_activity['NO_OF_ITEMS'] > 0) {
                                            for ($i = 0; $i < $extra_curr_activity['NO_OF_ITEMS']; $i++) {
                                                ...
                                                <?php } ?>
                                                <td>
                                                    <input type="button" class="btn btn-primary" style="cursor: pointer;" value="Add row" onclick="addRow2('table7', 'eca_activity', 'eca_slno', 'skill', '0')">
                                                </td>
                                            </tr>
                                        <?php } else { ?>
                                            <tr>
